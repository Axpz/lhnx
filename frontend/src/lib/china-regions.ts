...
export const chinaRegions: Region[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { code: '710500', name: '金门县' },
            { code: '710600', name: '南投县' },
            { code: '710700', name: '基隆市' },
            { code: '710800', name: '新竹市' },
            { code: '710900', name: '嘉义市' },
            { code: '711100', name: '新北市' },
            { code: '711200', name: '宜兰县' },
            { code: '711300', name: '新竹县' },
            { code: '711400', name: '桃园县' },
            { code: '711500', name: '苗栗县' },
            { code: '711700', name: '彰化县' },
            { code: '711900', name: '嘉义县' },
            { code: '712100', name: '云林县' },
            { code: '712400', name: '屏东县' },
            { code: '712500', name: '台东县' },
            { code: '712600', name: '花莲县' },
            { code: '712700', name: '澎湖县' },
            { code: '712800', name: '连江县' }
        ]
    },
    {
        code: '810000',
...
// 根据省份名称获取城市列表
export const getCitiesByProvinceName = (provinceName: string): Region[] => {
...
export const getAllRegions = (): Array<{ value: string; label: string }> => {
    ...
    chinaRegions.forEach(province => {
        // 添加省份
        regions.push({ value: province.name, label: province.name })
